...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (result.success) {
            ...
            console.error("DEBUG: Registration failed with error:", result.error);
            setError(result.error || "Registration failed. Please check if the backend is running.");
        }
        setLoading(false);
    };
        ...
        <>
            ...
            <div className="flex flex-col items-center mb-8">
                ...
                <p className="text-slate-500 font-medium">
                    Join the next gen collaboration
                </p>
            </div>

            {/* Error Message */}
            {error && (
                <div className="mb-6 text-sm text-red-600 bg-red-50 border border-red-100 rounded-xl px-4 py-3 flex items-start gap-3">
